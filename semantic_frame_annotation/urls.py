"""semantic_frame_annotation URL Configuration
...
urlpatterns = [
	path('annotation_admin/', admin.site.urls, name="admin"),
	...
	# path('semeval', include('annotate.urls')),
	path('', include('annotate.urls')),
]

# handler404 = "annotate.views.handler404"
# handler500 = "annotate.views.handler500"
